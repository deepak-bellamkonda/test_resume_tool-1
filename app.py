...
if st.button("Submit"):
            ...
            prompt3 = "extract the work summary from the JSON data and rewrite it to create a compelling, well-structured paragraph suitable for a consulting candidate's resume. The output should reflect the person's key accomplishments, skills, and expertise in the consulting field."
