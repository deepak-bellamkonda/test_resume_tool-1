...
if st.button("Submit"):
            ...
            prompt4 = "extract the specified details from the JSON data and format the output so that it lists the Degree, Institute Name, Year of Graduation, and Grade for each educational experience. Ensure that you use only the data present in the JSON file and do not create or guess information. "
