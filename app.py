...
if st.button("Submit"):
            ...
            prompt3 = "Extract the work summary/description from the above and display the following :- 1. Work Description 2. Years of experience 3. Industries worked in.Then rephrase the summary to include the years of experience, industries worked in,so that it showcases the following values : Personal Impact,Entrepreneurial Drive,Inclusive Leadership,Courageous Change, Problem Solving, Expertise. Make it a single paragraphg. Do not repeat the values as they are, and it need not include all the values.Do not add any unknown information, do not repeat phrases. Limit the description to less than 50 words"
