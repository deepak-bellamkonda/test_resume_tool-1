...
if st.button("Submit"):
            ...
            prompt2 = "Extract the most recent role from the resume, and display it in this format : the role, the company, and the duration. Only display the asked information."
