...
if st.button("Submit"):
            ...
            prompt1 = "Look at the resume given. Then extract the following fields from the resume :Current Role the person is working in (Put it under 'Current Role' Heading), summary of their work experience (Put it under 'Work Summary' heading), their educational background (Put it under 'Education' Heading),their work experience in each role (Put it under 'Work Experience' Heading), their skills (Put it under 'Skills' Heading), and their extracurricular activities(Put it under 'Extracurriculars' Heading). Show each data under its relevant heading. The resume is :"
            prompt2 = "Examine the current role person is working in extracted above and identify if it is missing following data :Role Name, Current company, and Duration . If missing any detail, rewrite the current role using blanks for missing data .Only show the question asking for missing details. Don't show a description."
            ...
            prompt4 = "Extract the educational background from the above in JSON Format and ask the users if any of the following missing entries Degree,Institution ,GPA/Percentage ,Year for each education are present. and don't give me any extra suggestions "
