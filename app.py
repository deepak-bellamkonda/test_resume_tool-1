...
if st.button("Submit"):
            ...
            prompt2 = "Extract and display the details of the person's current role or most recent role, including the Role Name, Company, and Duration in separate lines. If there's no end date specified for the current role, assume it's an ongoing role. Only display this for one role. The data is : "
            ...
            prompt4 = "extract the specified details from the JSON data and format the output so that it lists the Degree, Institute Name, Year of Graduation, and Grade for each educational experience in separate lines. Ensure that you use only the data present in the JSON file and do not create or guess information. The data is : "
            prompt5 = "Extract the skills from the JSON data and then list up to four skills that are most relevant to a consulting role based on the information provided in the document. If less than 4 relevant skills exist, suggest some skills they can list in a consulting resume in a separate line. The data is : "
