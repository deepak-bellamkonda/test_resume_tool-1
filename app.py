...
if st.button("Submit"):
            ...
            prompt2 = "Extract and display the details of the person's current role or most recent role, including the Role Name, Company, and Duration. If there's no end date specified for the current role, assume it's an ongoing role. "
            prompt3 = "Extract the work summary/description from the above and display the following in a single paragraph in first person. Rephrase the summary to include the years of experience, industries worked in,so that it showcases the following values : Personal Impact,Entrepreneurial Drive,Inclusive Leadership,Courageous Change, Problem Solving, Expertise. Do not repeat the values as they are, and it need not include all the values.Do not add any unknown information, do not repeat phrases. Use creative sentence formations. Limit the description to less than 50 words"
